                ...
                <Card className="card">
                  ...
                  <CardActions>
                    <div className="actions">
                      <div className="space"/>
                      <a href="https://github.com/GerwinBosch">
                      ...
                      <a href="https://twitter.com/BoschGerwin">
                        <FontIcon className="fab fa-twitter"/>
                      </a>
                      <a href="https://www.twitch.tv/barriton">
                ...
                <Card className="card">
                  ...
                  <Card expanded={this.state.informaticsOpen}
                    ...
                    <CardText expandable>
                      ...
                      the notion that within large amount of seemingly unrelated
                      data, a relation can
                      be found which can be a solution to a problem.
                      <br/><br/>Another thing that interests me in the field is
                      giving data a form to
                      display to people, which (hopefully) makes them understand
                      the data more.
                  ...
                  <Card expanded={this.state.musicOpen}
                    ...
                    <CardText expandable>
                      ...
                      I'm currently playing baritone and tuba. I've been playing
                      since I was 9.
